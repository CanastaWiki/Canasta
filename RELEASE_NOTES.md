...
- 3.0.0 - June 17, 2025 - move most functionality into CanastaBase repository (which in turn uses MediaWiki 1.43), leaving only extension- and skin-specific code; place all exctension and skin installation settings into a single file, contents.yaml, which in turn inherts from "Recommended revisions" page
