...
# MediaWiki Core
RUN set -x; \
	git clone --depth 1 -b $MW_CORE_VERSION https://github.com/wikimedia/mediawiki-core.git $MW_HOME \
	&& cd $MW_HOME \
...
RUN set -x; \
	...
	# MinervaNeue
	&& git clone -b $MW_VERSION --single-branch https://github.com/wikimedia/mediawiki-skins-MinervaNeue $MW_HOME/skins/MinervaNeue \
...
RUN set -x; \
	...
	# BreadCrumbs2
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-BreadCrumbs2.git  $MW_HOME/extensions/BreadCrumbs2 \
	&& cd $MW_HOME/extensions/BreadCrumbs2 \
	&& git fetch "https://github.com/wikimedia/mediawiki-extensions-BreadCrumbs2" refs/changes/03/701603/1 \
	...
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-ContributionScores $MW_HOME/extensions/ContributionScores \
	&& cd $MW_HOME/extensions/ContributionScores \
	&& git checkout -q 46ebf438283913f103ba5dd03a3e4730bb9f87dc \
	# DataTransfer (v. 1.4)
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-DataTransfer $MW_HOME/extensions/DataTransfer \
	...
	# DisplayTitle
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-DisplayTitle $MW_HOME/extensions/DisplayTitle \
	...
	# Favorites
	&& git clone --single-branch -b $MW_VERSION https://github.com/wikimedia/mediawiki-extensions-Favorites $MW_HOME/extensions/Favorites \
	...
	&& git clone --single-branch -b $MW_VERSION https://github.com/wikimedia/mediawiki-extensions-GoogleAnalyticsMetrics $MW_HOME/extensions/GoogleAnalyticsMetrics \
	...
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-GoogleDocCreator $MW_HOME/extensions/GoogleDocCreator \
	...
	# HeadScript
	&& git clone --single-branch -b $MW_VERSION https://github.com/wikimedia/mediawiki-extensions-HeadScript $MW_HOME/extensions/HeadScript \
	...
	# LinkTarget
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-LinkTarget $MW_HOME/extensions/LinkTarget \
	...
	# LockAuthor
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-LockAuthor $MW_HOME/extensions/LockAuthor \
	...
	# Math
	&& git clone --single-branch -b $MW_VERSION https://github.com/wikimedia/mediawiki-extensions-Math $MW_HOME/extensions/Math \
	...
	# MobileDetect
	&& git clone --single-branch -b $MW_VERSION https://github.com/wikimedia/mediawiki-extensions-MobileDetect $MW_HOME/extensions/MobileDetect \
	...
	# OpenIDConnect
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-OpenIDConnect $MW_HOME/extensions/OpenIDConnect \
	&& cd $MW_HOME/extensions/OpenIDConnect \
	&& git checkout -q b44189a2fb29ee45330c64bcf57d6537f63b18df \
	# PageExchange
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-PageExchange $MW_HOME/extensions/PageExchange \
	...
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-RegularTooltips $MW_HOME/extensions/RegularTooltips \
	...
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-SemanticDrilldown $MW_HOME/extensions/SemanticDrilldown \
	...
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-UserFunctions $MW_HOME/extensions/UserFunctions \
	...
	# WikiSEO
	&& git clone --single-branch -b master https://github.com/wikimedia/mediawiki-extensions-WikiSEO $MW_HOME/extensions/WikiSEO \
